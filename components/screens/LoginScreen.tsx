    ...
    <div className="w-full max-w-md mx-auto px-4 py-8 text-white">
      ...
      >
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex p-3 rounded-2xl bg-gradient-to-tr from-blue-600 to-teal-400 text-slate-950 font-bold mb-1 shadow-lg">
            <LogIn className="w-6 h-6" />
          </div>
          <h2 className="text-2xl font-bold text-slate-100">Healthcare Portal Sign In</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-500 hover:to-teal-400 text-white font-bold text-sm shadow-lg hover:shadow-teal-500/25 transition-all"
          >
        ...
        <div className="space-y-2.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 p-2.5 rounded-xl bg-slate-800/90 hover:bg-slate-800 border border-white/10 text-xs font-semibold text-slate-200 transition-colors"
          >
